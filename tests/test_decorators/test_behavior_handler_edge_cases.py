...
async def test_handle_array_match_part_not_in_dict(
...
async def test_handle_array_match_not_a_list(tracker: BehaviorTracker) -> None:
...
async def test_handle_array_match_current_not_dict(
    tracker: BehaviorTracker,
) -> None:
    current = ["not", "a", "dict"]
    part = "items[]"
...
async def test_traverse_json_path_missing_key(tracker: BehaviorTracker) -> None:
...
async def test_traverse_json_path_not_a_dict(tracker: BehaviorTracker) -> None:
...
async def test_traverse_json_path_root_not_dict(tracker: BehaviorTracker) -> None:
    data = ["not", "a", "dict"]
    path = "some.path"
...
async def test_traverse_json_path_success(tracker: BehaviorTracker) -> None:
...
async def test_match_json_pattern_non_dict_in_path(
    tracker: BehaviorTracker,
) -> None:
...
async def test_match_json_pattern_missing_key_in_path(
    tracker: BehaviorTracker,
) -> None:
...
async def test_match_json_pattern_edge_cases(
